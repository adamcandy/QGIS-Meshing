  ...
  def run( self ):
    ...
    try:
      ...
      try:
        ...
        pass
      QMessageBox.information( self.iface.mainWindow(), QCoreApplication.translate( "RasterCalc", "Plugin error" ), QCoreApplication.translate( "RasterCalc", "Couldn't import Python module 'osgeo.gdal'. Without it you won't be able to run RasterCalc." ) )
      return
