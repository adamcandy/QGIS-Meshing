...
command = 	"-l LY --mesh --id "+test_uk_main_path+"/idfile.shp --defid 1 -g "+test+"/test_uk_main/test_uk_main_id.geo "+test_uk_main_path+"/domain.shp" # see modular_meshing.py for help
