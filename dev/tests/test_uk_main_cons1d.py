...
command = 	"-l LY --mesh -m -g "+test+"/test_uk_main/test_uk_main_Noid.geo"+test_uk_main_path+"/constant_metric_1d.nc "+test_uk_main_path+"/domain.shp" # see modular_meshing.py for help
