...
class Ui_RasterCalcDialog(object):
    def setupUi(self, RasterCalcDialog):
        ...
        RasterCalcDialog.setObjectName(_fromUtf8("Meshing Raster Calc Dialog"))
    ...
    def retranslateUi(self, RasterCalcDialog):
        RasterCalcDialog.setWindowTitle(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Meshing Raster Calc", None, QtGui.QApplication.UnicodeUTF8))
        self.rasterTree.headerItem().setText(0, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Available rasters", None, QtGui.QApplication.UnicodeUTF8))
        self.btnRParen.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "(", None, QtGui.QApplication.UnicodeUTF8))
        self.btnRParen.setToolTip("Left Parenthesis")

        self.btnAbs.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "abs", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAbs.setToolTip("Absolute Value")

        self.btnLog.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "log", None, QtGui.QApplication.UnicodeUTF8))
        self.btnLog.setToolTip("Logrithmic")

        self.btnLt.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "<", None, QtGui.QApplication.UnicodeUTF8))
        self.btnLt.setToolTip("Less Than")

        self.btnGt.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", ">", None, QtGui.QApplication.UnicodeUTF8))
        self.btnGt.setToolTip("Greater Than")
        
        self.btnSqrt.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "sqrt", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSqrt.setToolTip("Square Root")


        self.btnLParen.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", ")", None, QtGui.QApplication.UnicodeUTF8))
        self.btnLParen.setToolTip("Right Parenthesis")
        self.btnddx.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "ddx", None, QtGui.QApplication.UnicodeUTF8))
        self.btnddx.setToolTip("Derivitive with respect to x")
        self.btnDdy.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "ddy", None, QtGui.QApplication.UnicodeUTF8))
        self.btnDdy.setToolTip("Derivitive with respect to y")
        self.btnIntX.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "intx", None, QtGui.QApplication.UnicodeUTF8))
        self.btnIntX.setToolTip("Integrate with respect to x")
        self.btnIntY.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "inty", None, QtGui.QApplication.UnicodeUTF8))
        self.btnIntY.setToolTip("Integrate with respect to y")
        self.btnDvg.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "dvg", None, QtGui.QApplication.UnicodeUTF8))
        self.btnDvg.setToolTip("Divergence")
        self.btnIntS.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "intS", None, QtGui.QApplication.UnicodeUTF8))
        self.btnIntS.setToolTip("Surface Integral")
        self.btnIntF.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "intF", None, QtGui.QApplication.UnicodeUTF8))
        self.btnIntF.setToolTip("Integrate Fields")
        self.btnDdf.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "ddF", None, QtGui.QApplication.UnicodeUTF8))
        self.btnDdf.setToolTip("Differentiate fields")
        self.btnMmin.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "min", None, QtGui.QApplication.UnicodeUTF8))
        self.btnMmin.setToolTip("Minimum of upto 10 values")
        self.btnMmax.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "max", None, QtGui.QApplication.UnicodeUTF8))
        self.btnMmax.setToolTip("Maximum of upto 10 values")
        self.btnBand.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Get band from raster", None, QtGui.QApplication.UnicodeUTF8))
        self.btnBand.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "@", None, QtGui.QApplication.UnicodeUTF8))
        self.btnBand.setToolTip("Get band from raster layer")
        self.btnClip.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Clip lower and upper values", None, QtGui.QApplication.UnicodeUTF8))
        self.btnClip.setToolTip("Clip Lower and upper Values")
        self.btnClip.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "clip", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPresets.setItemText(0, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "NDVI (TM/ETM+)", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPresets.setItemText(1, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Difference", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSin.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "sin", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSin.setToolTip("Sine")
        self.btnAsin.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "asin", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAsin.setToolTip("Inverse Sine")
        self.btnExp.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "exp", None, QtGui.QApplication.UnicodeUTF8))
        self.btnExp.setToolTip("Exponantial")
        self.btnCos.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "cos", None, QtGui.QApplication.UnicodeUTF8))
        self.btnCos.setToolTip("Cosine")
        self.btnAcos.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "acos", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAcos.setToolTip("Inverse Cosine")
        self.btnLn.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "ln", None, QtGui.QApplication.UnicodeUTF8))
        self.btnLn.setToolTip("Natural Logrithmic")
        self.btnTan.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "tan", None, QtGui.QApplication.UnicodeUTF8))
        self.btnTan.setToolTip("Tan")
        self.btnAtan.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "atan", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAtan.setToolTip("Inverse tan")
        self.btnPower.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Raise to power", None, QtGui.QApplication.UnicodeUTF8))
        self.btnPower.setToolTip("Power")
        self.btnPower.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "^", None, QtGui.QApplication.UnicodeUTF8))
        self.btnMul.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Multiply arguments", None, QtGui.QApplication.UnicodeUTF8))
        self.btnMul.setToolTip("Multiply Arguments")
        self.btnMul.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "*", None, QtGui.QApplication.UnicodeUTF8))
        self.btnDiv.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Divide arguments", None, QtGui.QApplication.UnicodeUTF8))
        self.btnDiv.setToolTip("Divide argumets")
        self.btnDiv.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "/", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSub.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Subtract argiments", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSub.setToolTip("Subtract arguments")
        self.btnSub.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAdd.setWhatsThis(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Add arguments", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAdd.setToolTip("Add arguments")
        self.btnAdd.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.btnClearCommand.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Clear", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSaveExpression.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Save", None, QtGui.QApplication.UnicodeUTF8))
        self.btnLoadExpression.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Load", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Data type", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(0, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Byte", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(1, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "UInt16", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(2, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Int16", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(3, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "UInt32", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(4, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Int32", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(5, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Float32", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(6, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Float64", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(7, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "CInt16", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(8, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "CInt32", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(9, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "CFloat32", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbPixelFormat.setItemText(10, QtGui.QApplication.translate("Meshing Raster Calc Dialog", "CFloat64", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Save as", None, QtGui.QApplication.UnicodeUTF8))
        self.btnBrowse.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Browse", None, QtGui.QApplication.UnicodeUTF8))
        self.loadCheckBox.setText(QtGui.QApplication.translate("Meshing Raster Calc Dialog", "Add result to the map canvas", None, QtGui.QApplication.UnicodeUTF8))
