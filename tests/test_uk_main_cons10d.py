...
command = 	"-e -l LY --mesh -m -g "+test+"/"+fname+"/test_uk_main_10d.geo "+test_UK_mesh_path+"/constant_metric_10d.nc "+test_uk_main_path+"/domain.shp" # see modular_meshing.py for help
