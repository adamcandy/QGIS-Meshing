...
fname = "test_ids_LY" # just the name, no forward or backslashes!
command = 	"-e -l LY -g "+test+"/test_ids_LY/test_ids_LY.geo --mval 0.1 --mesh --id "+test_uk_main_path+"/idfile.shp "+test_uk_main_path+"/domain.shp" # see modular_meshing.py for help
