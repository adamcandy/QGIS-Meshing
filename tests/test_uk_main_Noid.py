...
command = 	"-e -l LY --mesh -m -g "+test+"/"+fname+"/test_uk_main_Noid.geo "+support_file_path+"/mesh_metric.nc "+test_uk_main_path+"/domain.shp" # see modular_meshing.py for help
