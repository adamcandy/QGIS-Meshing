...
fname = "test_northsea_trimmed"
command = 	"--line LY --mesh -g "+test+"/test_northsea_trimmed/test_northsea_trimmed.geo --id "+support_file_path+"/UTMFILES/idfile.shp "+support_file_path+"/northsea_trimmed.shp"
