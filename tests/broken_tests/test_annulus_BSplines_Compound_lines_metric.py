...
fname = "test_annulus_BSplines_Compound_lines_metric"
command = "--line BY -g "+test+"/test_annulus_BSplines_Compound_lines_metric/test_annulus_BSplines_Compound_lines_metric.geo "+support_file_path+"/annulus.shp --mesh -m "+test+"/gaussian_bump.nc"
