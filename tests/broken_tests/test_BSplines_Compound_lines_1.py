...
fname = "test_BSplines_Compound_lines_1"
command =  "-l BY -g "+test+"/test_BSplines_Compound_lines_1/test_BSplines_Compound_lines_1.geo --id "+support_file_path+"/a_idLayer.shp "+support_file_path+"/rtopo_shape_DN__2.shp --mesh"
