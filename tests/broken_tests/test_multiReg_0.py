...
fname = "test_multiReq0" # just the name, no forward or backslashes!
command = 	"-l LY -g "+test+"/test_multiReq/test_multiReq0.geo --mesh "+support_file_path+"/annulus_multiReg0.shp" # see modular_meshing.py for help
