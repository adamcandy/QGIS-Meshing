...
fname = "test_multiReq2" # just the name, no forward or backslashes!
command = 	"-l LY -g "+test+"/test_multiReq/test_multiReq2.geo --mesh "+support_file_path+"/annulus_multiReg2.shp" # see modular_meshing.py for help
