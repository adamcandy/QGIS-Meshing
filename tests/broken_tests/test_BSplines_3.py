...
fname = "test_BSplines_3"
command = 	"--line BN -g "+test+"/test_BSplines_3/test_BSplines_3.geo --id "+support_file_path+"/a_idLayer.shp "+support_file_path+"/ID0Layer.shp  --mesh"
