...
fname = "test_multiReq1" # just the name, no forward or backslashes!
command = 	"-l LY -g "+test+"/test_multiReq/test_multiReq1.geo --mesh "+support_file_path+"/annulus_multiReg1.shp" # see modular_meshing.py for help
