...
fname = "test_BSplines_Compound_lines_2"
command = "-l BY -g "+test+"/test_BSplines_Compound_lines_2/test_BSplines_Compound_lines_2.geo "+support_file_path+"/ID0Layer.shp --mesh"
