...
fname = "test_Compound_lines_3"
command = "-e -l LY -g "+test+"/test_Compound_lines_3/test_Compound_lines_3.geo --id "+support_file_path+"/a_idLayer.shp "+support_file_path+"/ID0Layer.shp --mesh"
